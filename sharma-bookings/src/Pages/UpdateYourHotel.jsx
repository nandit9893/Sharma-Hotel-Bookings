        ...
        <div className="flex gap-4 sm:flex-row flex-col">
          <div className="flex flex-col flex-1 gap-2">
            <div className="flex flex-col gap-1">
              ...
              <textarea name="description" id="description" value={data.description} placeholder="description" maxLength="300" minLength="50"  className="border p-2 rounded-lg w-full sm:h-auto h-44" rows="4" onChange={inputChangeHandler} ></textarea>
            </div>
            <div className="flex flex-col gap-1">
                ...
                (
                  data.restaurants.map((restaurant) => (
                    <div key={restaurant._id} className="flex gap-3 mt-4 items-center justify-center">
                      <select name="nearByPlaces" id="nearByPlaces" className="border p-2 rounded-lg sm:w-96 w-36 sm:text-xl text-lg">
                        <option value="restaurants">Restaurants</option>
                      </select>
                      <input readOnly name="name" id="name" type="text" value={restaurant.name} className="sm:text-xl text-lg border p-2 rounded-lg w-full" placeholder="Name of place" />
                      <input readOnly name="distance" id="distance" type="number" value={restaurant.distance} max="30" className="sm:text-xl text-lg border p-2 rounded-lg sm:w-20 w-14" placeholder="Distance (in km)" />
                ...
                (
                  data.cinemaHalls.map((cinemaHall) => (
                    <div key={cinemaHall._id} className="flex gap-3 mt-4 items-center justify-center">
                      ...
                      <input readOnly name="name" id="name" type="text" value={cinemaHall.name} className="sm:text-xl text-lg border p-2 rounded-lg w-full" placeholder="Name of place" />
                      <input readOnly name="distance" id="distance" type="number" value={cinemaHall.distance} max="30" className="sm:text-xl text-lg border p-2 rounded-lg sm:w-20 w-14" placeholder="Distance (in km)" />
                ...
                (
                  data.transportationFacilities.map((transportationFacility) => (
                    <div key={transportationFacility._id} className="flex gap-3 mt-4 items-center justify-center">
                      ...
                      <input readOnly name="name" id="name" type="text" value={transportationFacility.name} className="sm:text-xl text-lg border p-2 rounded-lg w-full" placeholder="Name of place" />
                      <input readOnly name="distance" id="distance" type="number" value={transportationFacility.distance} max="30" className="sm:text-xl text-lg border p-2 rounded-lg sm:w-20 w-14" placeholder="Distance (in km)" />
                ...
                (
                  data.famousTouristPlaces.map((famousTouristPlace) => (
                    <div key={famousTouristPlace._id} className="flex gap-3 mt-4 items-center justify-center">
                      ...
                      <input readOnly name="name" id="name" type="text" value={famousTouristPlace.name} className="sm:text-xl text-lg border p-2 rounded-lg w-full" placeholder="Name of place" />
                      <input readOnly name="distance" id="distance" type="number" value={famousTouristPlace.distance} max="30" className="sm:text-xl text-lg border p-2 rounded-lg sm:w-20 w-14" placeholder="Distance (in km)" />
              ...
              }
              {
                nearByPlacesOfHotel.map((place) => (
                  <div key={place.id} className="flex gap-3 mt-4 items-center justify-center">
                    ...
                    <input name="distance" id="distance" type="number" value={place.distance} max="30" min="5" onChange={(event)=>inputPlacesAndDistances(event, place.id)} className="sm:text-xl text-lg border p-2 rounded-lg sm:w-20 w-14" placeholder="Distance (in km)" />
