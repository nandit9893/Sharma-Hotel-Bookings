    ...
    <div className="flex flex-col">
      ...
      <div className="my-4 flex flex-col p-3 gap-5">
                  ...
                  bookings && bookings.length > 0 && (
                      bookings.map((booking) => (
                          <div className="grid grid-cols-7 w-full gap-2" key={booking._id}>
                              <p onClick={()=>getSpecificBooking(booking)} className="text-lg p-3 bg-white text-black font-semibold rounded-lg items-center text-center cursor-pointer">{booking.bookingID}</p>
                              <p onClick={()=>navigate(`/view-hotel/${booking.hotelID}`)} className="text-lg p-3 bg-white text-black font-semibold rounded-lg items-center text-center cursor-pointer">{booking.hotelName}</p>
                              <p onClick={()=>navigate(`/view-hotel/${booking.hotelID}`)} className="text-lg p-3 bg-white text-black font-semibold rounded-lg items-center text-center cursor-pointer">{booking.hotelAddress}{", "}{booking.hotelCity}</p>
        ...
        }
        {
          showSpecificBooking ? 
          (
            <div className="flex flex-col bg-white p-4 gap-2 mx-auto w-[40%] border-2 border-blue-600 rounded-xl">
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Booking ID</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.bookingID}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Hotel Name</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.hotelName}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Hotel Address</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.hotelAddress}, {specificBookingData.hotelCity}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Date of Booking</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.dateOfBooking.slice(0, 10)}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Date of Commencement</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.dateOfCommencement.slice(0, 10)}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Number of Nights</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.numberOfNights}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Number of Guests</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.numberOfGuests}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Number of Rooms</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.numberOfRooms}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Room / Flat Type</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.roomType}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Room / Flat Standard</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>{specificBookingData.roomStandard}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Total Amount</p>
                <span className="text-2xl font-semibold text-blue-500" style={{ fontFamily: "Stylish" }}>₹ {specificBookingData.totalAmount - specificBookingData.discountAmount}</span>
              </div>
              <div className="flex justify-between">
                <p className="text-2xl font-semibold">Your Discount</p>
                <span className="text-2xl font-semibold text-red-500" style={{ fontFamily: "Stylish" }}>₹ {specificBookingData.discountAmount}</span>
              </div>
            </div>
          )
          :
