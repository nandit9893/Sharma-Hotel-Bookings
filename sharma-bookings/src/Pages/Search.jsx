        ...
        <div className="flex flex-col h-[600px] overflow-y-auto cursor-pointer scrollbar scrollbar-thumb-[#4B5563] scrollbar-track-[#E5E7EB] pr-4">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-1 items-center justify-between">
              ...
              <input type="number" className="rounded-lg p-2 outline-none w-44" name="minPrice" value={hotelSearchData.minPrice} min="0" onChange={inputChangeHandlerHotels} />
            </div>
            <div className="flex gap-1 items-center justify-between">
              <p className="text-xl">Max Price</p>
              <input type="number" className="rounded-lg p-2 outline-none w-44" name="maxPrice" value={hotelSearchData.maxPrice} min="0" onChange={inputChangeHandlerHotels} />
            </div>
            <div className="flex gap-1 items-center justify-between">
              <p className="text-xl">Starting Price</p>
              <input type="number" className="rounded-lg p-2 outline-none w-44" name="startingPrice" value={hotelSearchData.startingPrice} min="0" onChange={inputChangeHandlerHotels} />
            </div>
            <div className="flex gap-1 items-center justify-between">
          ...
          <form onSubmit={searchOnTheBasisOfRooms} className="flex flex-col gap-2">
            ...
            <div className="flex gap-5 items-center justify-between">
              ...
              <input type="number" className="rounded-lg p-2 outline-none w-48" name="pricePerNight" id="pricePerNight" value={roomSearchData.pricePerNight} onChange={inputChangeHandlerRooms} placeholder="₹" min="0" />
            </div>
