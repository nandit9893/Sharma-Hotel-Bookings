    ...
    <div className="flex flex-col gap-14 relative">
      ...
      <div className="my-2 flex justify-center sm:p-10 p-0 w-full">
        <div className="relative w-full sm:px-10">
          ...
          <button className="absolute top-28 sm:top-80 bg-white sm:p-3 p-1 px-2 rounded-md sm:w-52 w-36 left-44 hover:opacity-75 transition duration-300"><p className="text-2xl font-bold">Book Now</p></button>
