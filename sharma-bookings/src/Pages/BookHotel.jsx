...
const BookHotel = () => {
  ...
  return (
    <div className="my-10 flex gap-5 mx-32">
      <div className="flex flex-col border border-gray-300 w-2/3 rounded-lg">
      {
        payablePage ? 
        (
            ...
            <div className="p-5 flex justify-between gap-5">
              <div className="flex flex-col gap-2 w-1/2">
                ...
                <div className="flex">
                  ...
                  <input type="tel" placeholder="e.g., 1234657890" name="customerPhoneNumber" value={bookingFormData.customerPhoneNumber} onChange={inputChangeHandler} className="p-2 rounded border border-gray-300 flex-1 ml-2"/>
                </div>
              </div>
              <div className="flex flex-col gap-1 w-1/2">
                {
                  ...
                  (
                    ...
                    :
                    ( <button disabled={OTPVerified} className={`${OTPVerified || !lengthOfPhoneNumber ? "bg-gray-400 cursor-not-allowed" : "bg-green-700 cursor-pointer"} justify-center h-full mt-9 rounded-sm text-white text-xl`} onClick={sentOTPToEmail} type="button">Send</button> )
                  )
                }
              </div>
            </div>
      ...
      <div className="flex flex-col gap-1 border-[2px] border-gray-300 bg-gray-100 rounded-md p-2 relative" style={{ boxShadow: "0px 3px 5px rgba(0, 0, 0, 0.1), 0px -3px 5px rgba(0, 0, 0, 0.1), 3px 0px 5px rgba(0, 0, 0, 0.1), -3px 0px 5px rgba(0, 0, 0, 0.1)"}}>
        ...
        <div className="flex justify-between p-3">
          <div className="flex gap-1 border-[2px] border-gray-400 rounded-md items-center">
        ...
        <div className="flex justify-between p-3">
          ...
          <input type="number" name="numberOfNights" onChange={inputNumberOfGuestsHandler} value={bookingFormData.numberOfNights} className="p-1 px-3 outline-none border-none rounded-md" min="1" />
        </div>
        <div className="flex justify-between p-3">
          {
