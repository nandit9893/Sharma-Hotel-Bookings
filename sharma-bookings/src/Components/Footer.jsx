      ...
      <div className="flex sm:flex-row flex-col justify-between">
        <div className="mt-4">
            ...
            <div className="flex gap-4 mt-8 justify-between">
                <img src={apple_play_store} className="sm:w-44 w-40 border-2 border-white rounded-lg cursor-pointer" alt="" />
                <img src={google_play_store} className="sm:w-44 w-40 border-2 border-white rounded-lg cursor-pointer" alt="" />
            </div>
        </div>
