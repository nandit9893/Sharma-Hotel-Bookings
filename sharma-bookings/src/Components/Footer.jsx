...
const Footer = () => {
  ...
  return (
    <div className="mt-48 pt-6 pb-5 pl-14 pr-14 bg-[#777a7f]">
      <div className="flex justify-between">
        <div className="flex items-center">
          <div className="flex flex-col mr-8">
            <h1 className="font-bold text-lg sm:text-xl md:text-2xl flex flex-col">
              <span className="text-white text-4xl">SHARMA</span>
              <span className="text-white">RESIDENT STAY'S</span>
            </h1>
          </div>
          <p className="text-white font-bold text-xl">World's leading chain of hotels and homes</p>
        </div>
        <div className="flex items-center gap-3">
          <p className="text-white font-bold text-xl">Join our network and grow your business!</p>
          <button onClick={()=>navigate("/login-hotel-owner")} className="flex items-center mt-2 p-2 bg-white rounded-lg">
            <img src={property_logo} alt="Property logo" className="mr-2 w-8 h-8rounded-sm" />
            <p className="text-[#777a7f] font-semibold">List your property</p>
          </button>
        </div>
      </div>
      ...
      <div className="flex justify-between">
        <div className="mt-4">
            ...
            <div className="flex gap-4 mt-8">
                <img src={apple_play_store} className="w-44 border-2 border-white rounded-lg cursor-pointer" alt="" />
                <img src={google_play_store} className="w-44 border-2 border-white rounded-lg cursor-pointer" alt="" />
            </div>
        </div>
        <hr className="border-l-2 border-white h-36 my-4" />
      ...
      <div className="flex flex-col">
        <p className="text-white text-xl font-semibold">Every part of the world <span className="text-3xl font-bold">SHARMA RESIDENCY STAY's </span>hotels and rooms are avilable!!</p>
        <div className="flex justify-between">
            <ul>
      ...
      <div className="flex justify-between">
        <div className="flex gap-4">
            ...
            <a href=""><FaTwitter className="text-white text-3xl"/></a>
            <a href=""><FaYoutube className="text-white text-3xl"/></a>
        </div>
        <div className="flex">
            <p className="text-white font-semibold">2023-24 &copy; All Rights Reserved</p>
        </div>
      </div>
    </div>
  );
