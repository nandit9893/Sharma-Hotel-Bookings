    ...
    <header className="bg-blue-100 shadow-lg">
      <div className="flex justify-between items-center max-w-8xl p-2 px-5">
        ...
        <div className="flex sm:gap-5 gap-0">
          ...
          <Link to="/about"><p className="text-slate-700 hover:underline hover:text-gray-500 transition-all 0.5s font-semibold sm:text-xl text-xs cursor-pointer">ABOUT</p></Link>
          {
            currentUser ?
            ( currentUser.role === "hotel-owner" ? 
            ...
            :
            (
              <Link to="/login-user"><p className="text-slate-700 hover:underline hover:text-gray-500 transition-all 0.5s font-semibold text-xs sm:text-xl cursor-pointer">LOGIN</p></Link>
            )
          }
        </div>
      </div>
