            ...
            <div className="flex flex-col p-2">
              <div className="flex justify-between p-2">
                <div className="flex flex-col p-2 gap-2">
                  <h2 className="font-bold text-gray-500 text-4xl" style={{ fontFamily: "Faculty Glyphic, sans-serif" }}>{room.roomStandard}</h2>
                  ...
                  <div className="py-4">
                    <div className="grid gap-8 md:gap-20 mt-5 grid-cols-1 md:grid-cols-2">
                  ...
                  <div className="my-3">
                    ...
                    <div className="p-3 gap-1 grid grid-cols-2">
                      {
                ...
                <div className="flex flex-col gap-2 p-1">
                  {
                    room.imageURLs.map((image, index) => (
                      <img src={image} alt="" key={index} className="cursor-pointer w-64 h-40 rounded-lg transition-transform duration-300 ease-in-out hover:scale-105" />
                    ))
                  }
                </div>
              </div>
              ...
              <div className="flex justify-between p-3">
                ...
                <div onClick={()=>selectedRoomData(room)} className="flex gap-5 items-center px-10 border-[1px] border-gray-500 rounded-lg cursor-pointer w-64">
